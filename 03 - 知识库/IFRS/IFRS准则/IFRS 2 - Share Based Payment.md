...
were granted, including cancellations and settlements 26
...
Transactions (Amendments to IFRS 2) issued in June 2016
continued...
IFRS 2
A146 © IFRS Foundation
...
in the Glossary. IFRS 2 should be read in the context of its objective and the Basis for
...
he/she is a holder of equity instruments of that particular class, the granting
...
or are in return for continued service to be recognised in the post-combination
...
2003)1 or paragraphs 2.4–2.7 of IFRS 9 Financial Instruments.
...
date, in which case an expense is recognised when the goods are consumed or
sold. However, sometimes it is necessary to recognise an expense before the
...
additional benefits. Estimating the fair value of those additional benefits is
9
10
11
12
...
likely to be difficult. Because of the difficulty of measuring directly the fair
...
received. In this case, on grant date the entity shall recognise the services
...
growth in profit or a specified increase in the entity’s share price. Vesting
16
17
18
19
...
basis, no amount is recognised for goods or services received if the equity
...
equity instruments with market conditions, the entity shall recognise the
...
example, the entity shall not subsequently reverse the amount recognised for
...
final settlement, with any change in intrinsic value recognised in
...
not apply. The amount recognised for goods or services received during
...
reverse the amount recognised for goods or services received if the
...
therefore recognise immediately the amount that would otherwise
have been recognised for services received over the remainder of the
vesting period.
...
counterparty renders service.
The entity shall recognise, as a minimum, the services received measured at
...
of equity instruments. In addition, the entity shall recognise the effects of
...
payment exceeds the fair value of the equity instruments granted ,
26
27
28
IFRS 2
A156 © IFRS Foundation

measured at the repurchase date. Any such excess shall be recognised
...
share appreciation rights have been received. Thus, the entity shall recognise
...
share-based payment transaction is settled in cash 4 or by issuing equity
...
The amount recognised by the entity receiving the goods or services may
differ from the amount recognised by the consolidated group or by another
...
the group receives the goods or services shall recognise the transaction as
...
Accounting Policies, Changes in Accounting Estimates and Errors 5 if and only if it is
...
62
63
5 When it issued IFRS 18  Presentation and Disclosure in Financial Statements  in April 2024, the IASB
...
amounts previously recognised in the group’s consolidated financial
...
Changes in Accounting Estimates and Errors.6 However, if an entity determines that
...
entity after deducting all of its liabilities.7
equity instrument
granted
...
7 The Conceptual Framework for Financial Reporting  issued in 2018 defines a liability as a present
obligation of the entity to transfer an economic resource as a result of past events.
IFRS 2
A170 © IFRS Foundation
...
CU15,8 on a share with a fair value of CU20, has an intrinsic
value of CU5.
...
8 In this appendix, monetary amounts are denominated in ‘currency units (CU)’.
IFRS 2
...
share-based payment
arrangement
An agreement between the entity (or another group 9 entity or
...
9 A ‘group’ is defined in Appendix A of IFRS 10 Consolidated Financial Statements as ‘a parent and its
subsidiaries’ from the perspective of the reporting entity’s ultimate parent.
IFRS 2
A172 © IFRS Foundation
...
homogeneous exercise behaviour will result in a more accurate estimate of
...
expressed in annualised terms that are comparable regardless of the time
...
settlement of that grant of equity instruments, the entity should recognise, as
...
recognise the effects of modifications that increase the total fair value of the
...
recognised immediately, or over the vesting period if the employee is
...
transaction that changes its classification from cash-
...
is recognised in equity on the modification date to the extent to which
...
derecognised and the amount of equity recognised on the modification
date is recognised immediately in profit or loss.
...
B60
IFRS 2
A186 © IFRS Foundation

subsidiary shall recognise any change in the fair value of the equity
