...
Annual Improvements to IFRS Standards 2014 –2016 Cycle (issued December 2016), Amendments
to References to the Conceptual Framework in IFRS Standards  (issued March 2018) and Annual
Improvements to IFRS Accounting Standards—Volume 11  (issued July 2024).
IFRS 10
A574 © IFRS Foundation
...
> 💡 **中文注释：** "联系（Link）"是控制三要素中最容易被忽视的一环——主体必须能够运用其权力来影响可变回报的金额。如果主体虽然对被投资方有权力和回报敞口，但权力是由其他人代为行使（即主体是委托人还是代理人？），则主体可能不控制被投资方。判断代理人的关键指标：决策权范围、其他方拥有的实质性罢免权、报酬的水平和可变性。
...
other terms are given in the Glossary. IFRS 10 should be read in the context of
...
> 💡 **中文注释：** IFRS 10 确立了以"控制（Control）"为唯一合并基础的单一模型，取代了 IAS 27 和 SIC-12 中的"权力+风险与报酬"双重标准。控制的三要素必须全部满足：权力（Power）、可变回报的敞口（Exposure to variable returns）、运用权力影响回报的"联系"（Link）。不存在持股比例的明确门槛——实质重于形式。
...
> 💡 **中文注释：** "权力"指对被投资方相关活动（relevant activities）具有现时能力来主导决策。相关活动包括：经营和融资决策、预算批准、关键管理人员的任命和薪酬等。权力来源可以是表决权（多数持股）、合同安排（结构化主体的管理协议），或两者的组合。注意：即使未行使权力（如不投票），只要有能力行使即构成控制。
...
> 💡 **中文注释：** "可变回报"指来自被投资方的回报随其业绩变动——不局限于股利和利息，还包括：规模经济、成本节约、稀缺资源获取、专有知识获取、税务利益、协同效应等。回报可以是正面的（利润）也可以是负面的（亏损）。判断时需考虑回报的绝对值和可变性——回报越大、波动性越强，越可能构成控制。
...
32
33
1 Paragraph C7 of IFRS 10 Consolidated Financial Statements  states “If an entity applies this IFRS but
does not yet apply IFRS 9, any reference in this IFRS to IFRS 9 shall be read as a reference to
...
the relevant activities.
Power when voting or similar rights do not have a significant effect
...
de facto agent when the investor has the ability to direct that party to act on
the investor’s behalf. A party might also be a de facto agent when those that
direct the activities of the investor have the ability to direct that party to act
on the investor’s behalf. The investor shall consider its de facto agent’s
...
the specified liability do not have rights or obligations related to the
specified assets or to residual cash flows from those assets. In
...
example, if changes to the rights of the investor, or of other parties, occur, the
...
investment entity shall apply the requirements of paragraphs 25 and 26  to
B100
B101
IFRS 10
A624 © IFRS Foundation

those subsidiaries that it ceases to consolidate as though the investment entity
...
2024, amended paragraph B74. An entity shall apply those amendments for
...
C1E
IFRS 10
A626 © IFRS Foundation

Transition
An entity shall apply this IFRS retrospectively, in accordance with IAS 8
Accounting Policies, Changes in Accounting Estimates and Errors ,2 except as specified
...
Board. Mr Kabureck, Ms Lloyd and Mr Ochi dissented 3 from the issue of the amendments
...
Mary Tokar
Wei-Guo Zhang
3 Ms Patricia McConnell (former IASB member) intended to dissent from the issue of the
amendments to IFRS 10 and IAS 28 for the same reasons as Ms Lloyd and Mr Ochi. Her dissenting
opinion is not included in these amendments, because her term as an IASB member expired on
30 June 2014.
IFRS 10
