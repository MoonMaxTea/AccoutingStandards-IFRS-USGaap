...
D Consequential amendments to IFRS 1 First-time Adoption of International
...
(ii)
help users of the financial statements to understand the
...
(b)
recognised amounts that qualify as regulatory deferral account
...
needs of users and no less reliable1, or more reliable and no less relevant to
...
17
1
In 2010, the IASB replaced the IASC's Framework for the Preparation and Presentation of Financial
Statements adopted by the IASB in 2001 (Framework) with the Conceptual Framework for Financial
Reporting (Conceptual Framework). The term "faithful representation", which was used in the
Conceptual Framework issued in 2010 and is also used in the revised version of the Conceptual
Framework issued in 2018, encompasses the main characteristics that the Framework called
"reliability". The requirement in paragraph 13 of this Standard is based on the requirements of
IAS 8, which retains the term "reliable".
IFRS 14
A736
© IFRS Foundation
Presentation
...
(a)
the nature of, and the risks associated with, the rate regulation that
establishes the price(s) that the entity can charge customers for the
goods or services it provides; and
(b)
the effects of that rate regulation on its financial position, financial
...
of the following:
(a)
the level of detail that is necessary to satisfy the disclosure
requirements;
(b)
...
(i)
demand risk (for example, changes in consumer attitudes, the
availability of alternative sources of supply or the level of
competition);
(ii)
regulatory risk (for example, the submission or approval of a
...
usually be relevant:
(i)
the amounts that have been recognised in the current period in
the statement of financial position as regulatory deferral
account balances;
(ii)
the amounts that have been recognised in the statement(s) of
...
(iii)
other amounts, separately identified, that affected the
...
or discount rates;
(b)
the rate of return or discount rate (including a zero rate or a range of
...
(c)
the remaining periods over which the entity expects to recover (or
...
rate regulation
A framework for establishing the prices that can be charged to
customers for goods or services and that framework is subject
to oversight and/or approval by a rate regulator.
rate regulator
An authorised body that is empowered by statute or regulation
...
(a)
the entity's own governing body or a related party establishes rates
...
and
(b)
the framework is subject to oversight and/or approval by an authorised
...
practices:
(a)
recognising a regulatory deferral account debit balance when the
...
(b)
recognising, as a regulatory deferral account debit or credit balance, an
...
(c)
recognising a regulatory deferral account credit balance when the
...
(d)
measuring regulatory deferral account balances on an undiscounted
...
(ii)
costs of approved 'green energy' initiatives (in excess of amounts that
are capitalised as part of the cost of property, plant and equipment in
accordance with IAS 16 Property, Plant and Equipment);
(iii)
non-directly-attributable overhead costs that are treated as capital
...
(vi)
deemed interest (including amounts allowed for funds that are used
...
timing differences may arise that create new or revised regulatory deferral
B5
B6
IFRS 14
© IFRS Foundation
A743
account balances. The prohibition in paragraph 13 that prevents an entity
...
position related to income tax, in accordance with its accounting policies
B7
B8
B9
B10
...
A744
© IFRS Foundation
established in accordance with paragraphs 11-12. The recognition of this
...
(a)
with the line items that are presented for the regulatory deferral
account debit balances and credit balances; or
(b)
as a separate line item alongside the related regulatory deferral
...
(a)
with the line items that are presented in the statement(s) of profit or
loss and other comprehensive income for the movements in regulatory
deferral account balances; or
(b)
as a separate line item alongside the related line items that are
...
an entity shall present the earnings per share required by paragraph 26 of this
B11
B12
B13
B14
...
© IFRS Foundation
A745
Standard with equal prominence to the earnings per share required by IAS 33
...
operation either:
(a)
within the line item that is presented for movements in the regulatory
deferral account balances related to profit or loss; or
(b)
as a separate line item alongside the related line item that is presented
...
either:
(a)
within the line items that are presented for the regulatory deferral
account debit balances and credit balances; or
(b)
as separate line items alongside the other regulatory deferral account
...
accounting policies to the regulatory deferral account balances arising in all of
B20
B21
B22
B23
...
© IFRS Foundation
A747
its subsidiaries. This shall apply irrespective of whether the subsidiaries
...
A749
Appendix D
Consequential amendments to IFRS 1 First-time Adoption of
...
A750
© IFRS Foundation
Approval by the Board of IFRS 14 Regulatory Deferral Accounts
