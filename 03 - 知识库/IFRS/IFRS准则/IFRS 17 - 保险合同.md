...
© IFRS Foundation
A875
IFRS 17  Insurance Contracts is set out in paragraphs 1-132 and appendices A-D. All the
...
(c)
investment contracts with discretionary participation features it issues,
...
(b)
investment contracts with discretionary participation features as set
...
(h)
credit card contracts, or similar contracts that provide credit or
...
(c)
the insurance risk transferred by the contract arises primarily from
...
component for services other than insurance contract services (or both). An entity
shall apply paragraphs 11-13 to identify and account for the components of
the contract.
An entity shall:
(a)
apply IFRS 9 to determine whether there is an embedded derivative to
be separated and, if there is, how to account for that derivative.
(b)
separate from a host insurance contract an investment component if,
...
becoming onerous:
(a)
based on the likelihood of changes in assumptions which, if they
occurred, would result in the contracts becoming onerous.
(b)
using information about estimates provided by the entity's internal
...
(ii)
different possibilities of contracts becoming onerous after
initial recognition; and
(b)
more than one group of contracts that are onerous at initial
...
A882
© IFRS Foundation
An entity shall add a contract to the group in the reporting period in which
...
the group.
Insurance acquisition cash flows (paragraphs B35A‒
B35D)
...
paragraph 55(a)(iii).
If paragraph 28 applies, an entity shall apply paragraphs 28B‒28C in
...
(a)
for groups of insurance contracts meeting either of the criteria
...
(b)
the contractual service margin, measured applying paragraphs
38-39.
...
(i)
the entity has the practical ability to reassess the risks of the
...
A885
(b)
be consistent with observable current market prices (if any) for
...
(i)
any asset for insurance acquisition cash flows applying
paragraph 28C; and
(ii)
...
(b)
the liability for incurred claims, comprising the fulfilment cash flows
...
(a)
insurance revenue-for the reduction in the liability for remaining
...
(b)
insurance service expenses-for any subsequent changes in
...
A887
(i)
such increases in the fulfilment cash flows exceed the carrying
amount of the contractual service margin, giving rise to a loss
(see paragraph 48(a)); or
(ii)
such decreases in the fulfilment cash flows are allocated to the
loss
component
of
the
...
(d)
the effect of any currency exchange differences on the contractual
service margin; and
(e)
...
(ii)
the decrease in the amount of the entity's share of the fair
value of the underlying items exceeds the carrying amount of
the contractual service margin, giving rise to a loss (see
paragraph 48); or
(iii)
the increase in the amount of the entity's share of the fair
...
(a)
unfavourable changes relating to future service in the fulfilment cash
...
(b)
for a group of insurance contracts with direct participation features,
...
(a)
the subsequent changes in fulfilment cash flows of the liability for
...
(a)
estimates of the present value of future cash flows for claims and
expenses released from the liability for remaining coverage because of
incurred insurance service expenses;
(b)
changes in the risk adjustment for non-financial risk recognised in
...
(iii)
plus or minus any amount arising from the derecognition at
that date of:
1.
any asset for insurance acquisition cash flows applying
paragraph 28C; and
2.
any other asset or liability previously recognised for
...
(ii)
minus insurance acquisition cash flows; unless the entity
...
A893
(b)
the amount derecognised at that date of any asset or liability
...
contracts held;
(c)
changes in the fulfilment cash flows, measured at the discount rates
specified in paragraph B72(c), to the extent that the change relates to
future service, unless:
(i)
the change results from a change in fulfilment cash flows
...
(ii)
the change results from applying paragraphs 57‒58 (on onerous
...
contractual service margin; and
(e)
the amount recognised in profit or loss because of services received in
...
the group:
(a)
the entity reasonably expects the resulting measurement would not
differ materially from the result of applying the requirements in
paragraphs 63-68; or
(b)
the coverage period of each contract in the group of reinsurance
...
© IFRS Foundation
A895
If an entity measures a group of reinsurance contracts held applying the
...
(c)
the allocation of the contractual service margin (see paragraphs 44(e)
...
(i)
the modified contract would have been excluded from the
scope of IFRS 17, applying paragraphs 3-8A;
(ii)
an entity would have separated different components from the
...
© IFRS Foundation
(iv)
the modified contract would have been included in a different
...
(c)
the entity applied the premium allocation approach in paragraphs
...
(a)
the fulfilment cash flows allocated to the group are adjusted to
...
(c)
the number of coverage units for expected remaining insurance
...
A897
(a)
adjust the contractual service margin of the group from which the
...
(iii)
the premium the entity would have charged had it entered into
...
into:
(a)
an insurance service result (paragraphs 83-86), comprising
...
A898
© IFRS Foundation
An entity is not required to disaggregate the change in the risk adjustment for
...
paragraphs 66(c)(i)‒(ii) and 66A‒66B as amounts recovered from the
reinsurer; and
(c)
...
© IFRS Foundation
A899
Insurance finance income or expenses (see paragraphs
B128-B136)
...
(c)
excluding any such changes for groups of insurance contracts with
...
A900
© IFRS Foundation
If an entity transfers a group of insurance contracts or derecognises an
...
(b)
it shall not reclassify to profit or loss as a reclassification
...
information about:
(a)
the amounts recognised in its financial statements for contracts
...
(c)
the nature and extent of the risks from contracts within the scope
...
© IFRS Foundation
A901
An entity shall aggregate or disaggregate information so that useful
...
characteristics.
Paragraphs 29-31 of IAS 1 set out requirements relating to materiality and
...
98-100, 102-103, 105‒105B and 109A apply to contracts to which the
...
(c)
the method it has chosen to recognise insurance acquisition cash
...
(a)
disclose, in a table, the reconciliations set out in paragraphs 100-105B;
and
(b)
for each reconciliation, present the net carrying amounts at the
...
(c)
the liabilities for incurred claims. For insurance contracts to which the
premium
allocation
approach
described
...
(iv)
changes that relate to future service, ie losses on onerous
...
A903
(a)
changes that relate to future service, applying paragraphs B96-B118,
showing separately:
(i)
changes in estimates that adjust the contractual service margin;
(ii)
changes in estimates that do not adjust the contractual service
...
(i)
premiums received for insurance contracts issued (or paid
...
(d)
any additional line items that may be necessary to understand the
...
comprising:
(a)
the amounts relating to the changes in the liability for remaining
coverage as specified in paragraph B124, separately disclosing:
(i)
the insurance service expenses incurred during the period as
specified in paragraph B124(a);
(ii)
the change in the risk adjustment for non-financial risk, as
...
(a)
contracts acquired from other entities in transfers of insurance
...
affected; and
(c)
the carrying amount of the group of insurance contracts to which the
...
A906
© IFRS Foundation
For all periods in which disclosures are made applying paragraphs 114(a) or
...
(b)
any changes in the methods and processes for estimating inputs used
to measure contracts, the reason for each change, and the type of
contracts affected.
(c)
to the extent not covered in (a), the approach used:
(i)
to distinguish changes in estimates of future cash flows arising
...
(ii)
to determine the risk adjustment for non-financial risk,
...
personnel.
(b)
the disclosures required by paragraphs 127-132, to the extent not
...
(a)
a sensitivity analysis that shows how profit or loss and equity would
...
(ii)
for each type of market risk-in a way that explains the
...
take the form of:
(i)
an analysis, by estimated timing, of the remaining contractual
...
(a)
for premium receipts (and any related cash flows such
...
(b)
for insurance service expenses (excluding insurance
...
(a)
that are expected to be a significant portion of the total
contractual benefits;
(b)
the timing or amount of which are contractually at the
...
(b)
pay amounts that are not included in (a) and that relate
to:
(i)
insurance contract services that have already
been provided; or
(ii)
...
(b)
pay amounts under existing insurance contracts that
are not included in (a) and that relate to:
(i)
insurance contract services not yet provided (ie
...
(b)
separation of components from an insurance contract (see paragraphs
B31-B35);
(ba)
...
A918
© IFRS Foundation
Consequently, a contract that exposes the entity to lapse risk, persistency risk
...
© IFRS Foundation
A919
insurance risk. An entity shall use the discount rates required in paragraph 36
...
(c)
a payment conditional on an event that does not cause a significant
loss to the holder of the contract. For example, consider a contract that
requires the issuer to pay CU1 million1 if an asset suffers physical
...
(d)
possible reinsurance recoveries. The entity accounts for these
separately.
...
A920
© IFRS Foundation
charges is not included in this assessment if that waiver does not compensate
...
(k)
insurance swaps and other contracts that require a payment depending
...
(b)
contracts that have the legal form of insurance, but return all
...
© IFRS Foundation
(c)
self-insurance (ie retaining a risk that could have been covered by
...
contract.
(f)
credit-related guarantees that require payments even if the holder has
...
(g)
contracts that require a payment that depends on a climatic, geological
or any other physical variable not specific to a party to the contract
(commonly described as weather derivatives).
(h)
contracts that provide for reduced payments of principal, interest or
...
(a)
the investment component and the insurance component are not
highly interrelated.
(b)
a contract with equivalent terms is sold, or could be sold, separately in
...
(a)
the entity is unable to measure one component without considering
...
A924
© IFRS Foundation
Promises to transfer distinct goods or services other than
...
(a)
the cash flows and risks associated with the good or service are highly
interrelated with the cash flows and risks associated with the
insurance components in the contract; and
(b)
the entity provides a significant service in integrating the good or
...
to that group; and
(ii)
to groups that will include insurance contracts that are
...
(a)
an entity shall recognise an impairment loss in profit or loss and
...
(ii)
the excess determined applying (b)(i) has not already been
recognised as an impairment loss applying (a).
Measurement (paragraphs 29-71)
Estimates of future cash flows (paragraphs 33-35)
This section addresses:
(a)
unbiased use of all reasonable and supportable information available
...
A926
© IFRS Foundation
entity's own information systems is considered to be available without undue
cost or effort.
...
A927
(ii)
there are indications that historical trends will not continue,
...
(iii)
there have been changes in items such as underwriting
procedures and claims management procedures that may affect
the relevance of historical data to the insurance contracts.
(d)
current price information, if available, for reinsurance contracts and
...
interest rates); and
(b)
non-market variables-all other variables (for example, the frequency
...
(a)
internal mortality statistics may be more persuasive than national
...
A929
(b)
conversely, if the internal statistics are derived from a small
...
consider whether:
(a)
the updated estimates faithfully represent the conditions at the end of
...
A930
© IFRS Foundation
not provide evidence of the conditions that existed at that date. For example,
...
© IFRS Foundation
A931
When estimating the cash flows, an entity shall take into account current
...
(g)
costs the entity will incur in providing contractual benefits paid in
kind.
(h)
policy administration and maintenance costs, such as costs of
...
(k)
potential cash inflows from recoveries (such as salvage and
...
(i)
performing investment activity, to the extent the entity
...
(l)
an allocation of fixed and variable overheads (such as the costs of
...
characteristics.
(m)
any other costs specifically chargeable to the policyholder under the
...
(a)
investment returns. Investments are recognised, measured and
presented separately.
(b)
cash flows (payments or receipts) that arise under reinsurance
contracts held. Reinsurance contracts held are recognised, measured
and presented separately.
(c)
cash flows that may arise from future insurance contracts, ie cash
flows
outside
the
boundary
...
© IFRS Foundation
(e)
cash flows that arise from abnormal amounts of wasted labour or
other resources that are used to fulfil the contract. Such costs are
recognised in profit or loss when incurred.
(f)
income tax payments and receipts the insurer does not pay or receive
in a fiduciary capacity or that are not specifically chargeable to the
policyholder under the terms of the contract.
(g)
cash flows between different components of the reporting entity, such
...
(h)
cash flows arising from components separated from the insurance
...
(a)
the policyholder to share with policyholders of other contracts the
returns on the same specified pool of underlying items; and
(b)
either:
(i)
the policyholder to bear a reduction in their share of the
...
(ii)
policyholders of other contracts to bear a reduction in their
...
and
(b)
exclude payments to policyholders in the group that, applying (a), have
...
(a)
to measure the fulfilment cash flows-current discount rates applying
paragraph 36;
(b)
to determine the interest to accrete on the contractual service margin
...
© IFRS Foundation
(c)
to measure the changes to the contractual service margin applying
...
(d)
for groups of contracts applying the premium allocation approach that
...
rate; and
(iii)
for groups of contracts applying the premium allocation
...
(ii)
adjusted for the effect of that variability and discounted at a
rate that reflects the adjustment made.
(c)
nominal cash flows (ie those that include the effect of inflation) shall
be discounted at rates that include the effect of inflation; and
(d)
real cash flows (ie those that exclude the effect of inflation) shall be
...
(a)
maximise the use of observable inputs (see paragraph B44) and reflect
...
© IFRS Foundation
(c)
exercise judgement to assess the degree of similarity between the
...
(b)
if a market is not active, an entity shall adjust observable market
...
(c)
if there is no market for assets in the reference portfolio, an entity
shall apply an estimation technique. For such assets (consistent with
paragraph 89 of IFRS 13) an entity shall:
(i)
develop unobservable inputs using the best information
...
A939
(ii)
adjust those data to reflect all information about market
...
(a)
adjusting for differences between the amount, timing and uncertainty
...
(a)
the degree of diversification benefit the entity includes when
...
low severity;
(b)
for similar risks, contracts with a longer duration will result in higher
...
in a transfer.
Applying paragraphs 14‒22, at the date of the transaction an entity might
...
scope of IFRS 3, the entity shall recognise an asset for insurance acquisition
...
(b)
future insurance contracts, other than those in (a), after the date of the
...
© IFRS Foundation
(ii)
the effect, if disaggregated, on the risk adjustment for non-
financial risk; and
(iii)
the effect of a change in discount rate.
(b)
changes in estimates of fulfilment cash flows in the liability for
incurred claims.
(c)
...
(a)
interpret the term 'substantial' in both paragraphs in the context of
...
financial risk on:
(a)
the amount of the entity's share of the underlying items (see
...
(b)
the fulfilment cash flows set out in paragraph B113(b) if the entity
...
(a)
identifying the coverage units in the group. The number of coverage
...
(b)
allocating the contractual service margin at the end of the period
...
A949
(b)
the entity expects the investment component or amount the
...
Applying paragraphs 14‒22, an entity might include in an onerous group of
...
(i)
insurance service expenses, excluding any amounts relating to
...
(a)
changes that do not relate to services provided in the period, for
example:
(i)
...
(iii)
changes that relate to transaction-based taxes collected on
...
A951
(b)
changes that relate to services, but for which the entity does not
...
(v)
the amount related to the risk adjustment for non-financial
risk (see (b)).
(b)
...
(ii)
changes that adjust the contractual service margin because
...
(b)
assumptions about inflation based on an entity's expectation of
specific price changes are not assumptions that relate to financial risk;
and
(c)
changes in the measurement of a group of insurance contracts caused
...
A953
(a)
is based on characteristics of the contracts, without reference to
...
(b)
results in the amounts recognised in other comprehensive income over
...
following ways:
(i)
using a rate that allocates the remaining revised expected
finance income or expenses over the remaining duration of the
group of contracts at a constant rate; or
(ii)
for contracts that use a crediting rate to determine amounts
...
(i)
for insurance contracts that do not have direct participation
...
periods, as follows:
(i)
if the entity had previously applied paragraph 88(b)-the entity
...
change; and
(ii)
if the entity had previously applied paragraph 89(b)-the entity
shall include in profit or loss the accumulated amount included
in other comprehensive income before the change as if the
...
December 2021, added paragraphs C28A-C28E and C33A. An entity that
chooses to apply paragraphs C28A-C28E and C33A shall apply them on initial
...
(a)
an entity is not required to present the quantitative information
required by paragraph 28(f) of IAS 8 Accounting Policies, Changes in
Accounting Estimates and Errors; and
(b)
an entity shall not apply the option in paragraph B115 for periods
...
(a)
the modified retrospective approach in paragraphs C6-C19A, subject to
paragraph C6(a); or
(b)
...
(a)
the modified retrospective approach in paragraphs C14B-C14D and
...
(a)
use reasonable and supportable information. If the entity cannot
...
yield curve exists.
(b)
if the observable yield curve in paragraph (a) does not exist, estimate
...
(a)
groups of insurance contracts that are recognised at the transition
date; and
(b)
...
A960
© IFRS Foundation
before the transition date, including those allocated to a group of insurance
...
(a)
the adjustment to the contractual service margin of a group of
...
C16 and C20); and
(b)
the percentage of claims for the underlying insurance contracts the
entity expects to recover from the group of reinsurance contracts held.
Applying paragraphs 14‒22, at the transition date an entity might include in
...
transition date.
(iv)
insurance acquisition cash flows paid (or for which a liability
has been recognised applying another IFRS Standard) before the
transition date that are allocated to the group (see
paragraph C17A).
(d)
if (a)-(c) result in a contractual service margin-minus the amount of
...
(a)
an entity is permitted to determine the discount rates at the date of
...
than one year apart:
(a)
if an entity applies paragraph C13 to estimate the discount rates that
...
appropriate; or
(b)
reasonable and supportable information available at the transition
date.
...
A965
(c)
for insurance contracts with direct participation features to which
...
(a)
recoveries of insurance acquisition cash flows from premiums of
...
apply paragraphs C28B-C28E (classification overlay) for the purpose of
...
(a)
disclose qualitative information that enables users of financial
statements to understand:
(i)
the extent to which the classification overlay has been applied
(for example, whether it has been applied to all financial assets
derecognised in the comparative period);
(ii)
whether and to what extent the impairment requirements in
Section 5.5 of IFRS 9 have been applied (see paragraph C28C);
(b)
only apply those paragraphs to comparative information for reporting
...
(a)
may reassess whether an eligible financial asset meets the condition in
...
(i)
the measurement category and carrying amount of the affected
financial assets determined immediately before the date of
initial application of IFRS 17; and
(ii)
the new measurement category and carrying amount of the
affected
financial
assets
determined
...
paragraph C29.
(c)
if paragraph C29(b) applies-the carrying amount of financial assets in
...
of IFRS 9; and
(c)
why the entity came to any different conclusions in the new
...
A972
© IFRS Foundation
Approval by the Board of Initial Application of IFRS 17 and IFRS 9
-Comparative Information issued in December 2021
Initial Application of IFRS 17 and IFRS 9-Comparative Information, which amends IFRS 17
