...
# IFRS 8 — Operating Segments（经营分部）


## 📌 中文提炼

要求主体基于**管理层视角（Management Approach）**披露经营分部信息，让报表使用者从管理层的角度了解主体。

### 核心方法：管理层法
按**首席经营决策者（CODM）**定期审阅的内部报告方式来划分和披露分部。

### 经营分部认定
- 从事可产生收入和发生费用的业务活动
- CODM 定期审阅其经营成果以分配资源和评价业绩
- 可获得独立的财务信息

### 量化门槛（满足任一即应单独报告）
- 收入（含外部和分部间）≥ 所有分部总收入的 **10%**
- 损益绝对值 ≥ 所有盈利分部合计利润与所有亏损分部合计亏损两者中较大者的 **10%**
- 资产 ≥ 所有分部总资产的 **10%**
- 单独报告的分部外部收入合计 ≥ 总外部收入的 **75%**
...
> 仅适用于上市公司和正在上市过程中的主体。采用管理层法可降低编制成本，但也降低了可比性。
...
Standards (issued March 2018), Disclosure of Accounting Policies  (issued February 2021) and
...
the Glossary. IFRS 8 should be read in the context of its core principle and the Basis for
...
paragraph 42 of IFRS 18 Presentation and Disclosure in Financial Statements;
...
(b) the amounts of additions to non -current assets 1 other than financial
...
countries.
(b) non- current assets 2 other than financial instruments, deferred tax
...
32
33
2 For assets classified according to a liquidity presentation, non -current assets are assets that
include amounts expected to be recovered more than twelve months after the reporting period.
IFRS 8
A368 © IFRS Foundation

this paragraph, subtotals of geographical information about groups of
countries.
...
36A
36B
3 In April 2024 the IASB issued IFRS 18  Presentation and Disclosure in Financial Statements  and carried
...
disclose that fact.
IFRS 18 issued in April 2024 amended paragraph 23. An entity shall apply
