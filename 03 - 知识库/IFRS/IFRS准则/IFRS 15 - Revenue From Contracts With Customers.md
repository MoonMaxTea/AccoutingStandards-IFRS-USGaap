...
IFRS 16 Leases (issued January 2016), Amendments to References to the Conceptual Framework in
IFRS Standards  (issued March 2018) and IFRS 18  Presentation and Disclosure in Financial
Statements (issued April 2024).
IFRS 15
© IFRS Foundation A777
...
Standard. Definitions of other terms are given in the Glossary. The Standard should be
read in the context of its objective and the Basis for Conclusions, the Preface to IFRS
Accounting Standards  and the Conceptual Framework for Financial Reporting . IAS 8 Basis of
Preparation of Financial Statements provides a basis for selecting and applying accounting
policies in the absence of explicit guidance.
IFRS 15
A780 © IFRS Foundation
...
> 💡 **中文注释：** 以下五步是 IFRS 15 收入确认的完整流程。注意：步骤必须按顺序执行——先识别合同，再识别履约义务，不能跳过。合同合并（combination of contracts）要求在同一时间或相近时间与同一客户签订的多个合同必须合并处理。
...
> 💡 **中文注释：** 合同识别五条件（缺一不可）：① 各方已批准合同并承诺履约；② 可识别各方对商品/服务的权利；③ 可识别付款条款；④ 具有商业实质（未来现金流风险/金额/时点预期会改变）；⑤ 对价很可能（probable）收回。实务中"很可能收回对价"是最常产生争议的条件。
...
> 💡 **中文注释：** "可明确区分（distinct）"是识别履约义务的核心判断。两步法：① 客户能否单独从该商品/服务获益？② 合同背景下该承诺能否与其他承诺区分开？需要综合考虑整合服务、重大修改/定制、高度关联性等因素。实务判断难点常在于软件许可+实施服务的组合。
...
change in accounting estimate in accordance with IAS 8  Basis of Preparation of
...
55
IFRS 15
A794 © IFRS Foundation

circumstances. To account for a refund liability relating to a sale with a right
...
> 💡 **中文注释：** 可变对价的"极可能不会重大转回"约束是 IFRS 15 最关键的判断之一。即使金额可估计，若转回风险高，也不能确认。实务中，业绩奖金、罚款条款、特许权使用费常涉及此判断。注意：知识产权许可的可变对价有特殊规则（例外处理）。
...
might provide the entity or the customer with protection from the
60
61
62
IFRS 15
A796 © IFRS Foundation

other party failing to adequately complete some or all of its obligations
under the contract.
...
82
IFRS 15
A800 © IFRS Foundation

performance obligations) to which the entire discount in the contract
belongs.
...
payment for performance completed to date if the contract were to be
B7
B8
B9
B10
IFRS 15
A814 © IFRS Foundation
...
B32
IFRS 15
© IFRS Foundation A819

entity promises both an assurance-type warranty and a service-type warranty
...
> 💡 **中文注释：** 主要责任人 vs 代理人——决定按总额（gross）还是净额（net）确认收入。判断核心：在商品/服务转移给客户之前，主体是否取得了对指定商品/服务的控制权？三个指标（不具决定性）：① 履约主要责任谁承担；② 存货风险谁承担；③ 定价自主权谁拥有。平台经济（电商、旅游预订）高度依赖此判断。
...
entity expects to be entitled to a breakage amount, the entity shall consider
B41
B42
B43
B44
...
B46
IFRS 15
© IFRS Foundation A823

the requirements in paragraphs 56 –58 on constraining estimates of variable
consideration.
...
can direct the use of, and obtain substantially all of the remaining benefits
B59
B59A
B60
B61
IFRS 15
A826 © IFRS Foundation

from, the licence at the point in time at which the licence transfers. An entity
...
amended paragraph 43. An entity shall apply those amendments when it
applies IFRS 18.
Transition
...
with IAS 8  Accounting Policies, Changes in Accounting Estimates and Errors ,1
...
members of the International Accounting Standards Board.2
...
Mary Tokar
Wei-Guo Zhang
2 Prabhakar Kalavacherla was a member of the IASB when it voted in November 2013 to begin the
