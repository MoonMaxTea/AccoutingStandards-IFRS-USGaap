...
# IAS 16 — Property, Plant and Equipment（不动产、厂房和设备）


## 📌 中文提炼

规范**PPE**的确认、计量、折旧和终止确认，是固定资产会计的基础准则。

### 初始计量
- 按**成本**计量：购买价格 + 直接归属成本 + 拆卸/恢复义务的初始估计
- 自建资产：按 IAS 2 等归集成本，利息按 IAS 23 资本化

### 后续计量：两种模式选择
| 模式 | 计量基础 | 适用 |
|------|----------|------|
| **成本模式** | 成本 − 累计折旧 − 累计减值 | 最常见 |
| **重估价模式** | 公允价值 − 后续折旧 − 后续减值 | 需能可靠计量公允价值 |

- 重估价模式须**整类资产**同时应用，不能选择性使用
- 重估价增加额 → OCI；减少额 → 当期损益

### 折旧（Depreciation）
- 折旧方法应反映**未来经济利益的预期消耗模式**
- 常用方法：直线法、余额递减法、工作量法
- 残值和使用寿命**每年至少复核一次**
- 土地通常不折旧（除非有开采权等使用期限）

### 组件法（Component Approach）
- 若某部件成本重大且使用寿命不同，须**单独折旧**
- 例：飞机机身 vs 发动机

### 终止确认
- 处置时确认利得/损失 = 净处置收入 − 账面价值
- 利得不计入收入

> 与 IAS 36（减值）、IAS 23（借款费用资本化）、IFRS 5（持有待售）联动。
...
1. its purchase price, including import duties and non‑refundable purchase taxes, after deducting trade discounts and rebates.[E2]
...
5. costs of testing whether the asset is functioning properly (ie assessing whether the technical and physical performance of the asset is such that it is capable of being used in the production or supply of goods or services, for rental to others, or for administrative purposes); and
6. professional fees.
...
4. legal or similar limits on the use of the asset, such as the expiry dates of related leases.[E3]
...
1. impairments of items of property, plant and equipment are recognised in accordance with IAS 36;
2. derecognition of items of property, plant and equipment retired or disposed of is determined in accordance with this Standard;
3. compensation from third parties for items of property, plant and equipment that were impaired, lost or given up is included in determining profit or loss when it becomes receivable; and
4. the cost of items of property, plant and equipment restored, purchased or constructed as replacements is determined in accordance with this Standard.
...
2. the amount of expenditures recognised in the carrying amount of an item of property, plant and equipment in the course of its construction; and
...
1. the amount of compensation from third parties for items of property, plant and equipment that were impaired, lost or given up that is included in profit or loss; and
2. the amounts of proceeds and cost included in profit or loss in accordance with paragraph 20A that relate to items produced that are not an output of the entity’s ordinary activities, and which line item(s) in the statement of comprehensive income include(s) such proceeds and cost.
...
3. [deleted]
4. for each revalued class of property, plant and equipment, the carrying amount that would have been recognised had the assets been carried under the cost model[E5]; and
5. the revaluation surplus, indicating the change for the period and any restrictions on the distribution of the balance to shareholders.
...
1. the carrying amount of temporarily idle property, plant and equipment;[E6]
2. the gross carrying amount of any fully depreciated property, plant and equipment that is still in use;
3. the carrying amount of property, plant and equipment retired from active use and not classified as held for sale in accordance with IFRS 5; and
...
**81B.** IAS 1 Presentation of Financial Statements (as revised in 2007) amended the terminology used throughout IFRSs. In addition it amended paragraphs 39, 40 and 73(e)(iv). An entity shall apply those amendments for annual periods beginning on or after 1 January 2009. If an entity applies IAS 1 (revised 2007) for an earlier period, the amendments shall be applied for that earlier period.1
...
**81O.** IFRS 18 Presentation and Disclosure in Financial Statements issued in April 2024 amended paragraph 51. An entity shall apply those amendments when it applies IFRS 18.
...
1. SIC‑6 Costs of Modifying Existing Software;
2. SIC‑14 Property, Plant and Equipment—Compensation for the Impairment or Loss of Items; and
3. SIC‑23 Property, Plant and Equipment—Major Inspection or Overhaul Costs.
