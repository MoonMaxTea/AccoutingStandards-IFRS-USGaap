...
Risk issued in March 2004
Transition and Initial Recognition of Financial Assets and Financial
Liabilities issued in December 2004
Cash Flow Hedge Accounting of Forecast Intragroup Transactions issued in
April 2005
Financial Guarantee Contracts (Amendments to IAS 39 and IFRS 4) issued
in August 2005
Eligible Hedged Items issued in July 2008
Embedded Derivatives (Amendments to IFRIC 9 and IAS 39) issued in
March 20091
Novation of Derivatives and Continuation of Hedge
Accounting (Amendments to IAS 39) issued in June 2013
...
(a)
IFRS 9 permits the hedge accounting requirements of this Standard
to be applied; and
(b)
...
on consolidation. Therefore, such hedging transactions do not qualify for
10-70
71
72
73
...
© IFRS Foundation
A1557
hedge accounting in the consolidated financial statements of the group.
...
the firm commitment attributable to the hedged risk that was recognised in
...
(a)
It reclassifies the associated gains and losses that were recognised in
...
(b)
the timing or the amount of interest rate benchmark-based cash flows
...
transaction must be highly probable, an entity shall assume that the interest
rate benchmark on which the hedged cash flows (contractually or non-
contractually specified) are based is not altered as a result of interest rate
benchmark reform.
102
102A
102B
...
© IFRS Foundation
(b)
when the hedging relationship that the hedged item is part of is
discontinued.
...
and
(b)
when the entire cumulative gain or loss recognised in other
...
(a)
to a hedged item, when the uncertainty arising from interest rate
...
(b)
to a hedging instrument, when the uncertainty arising from interest
...
(b)
when the hedging relationship to which the exception is applied is
discontinued.
...
earlier of:
(a)
when changes required by interest rate benchmark reform are made to
the non-contractually specified risk portion applying paragraph 102P;
or
(b)
when the hedging relationship in which the non-contractually
...
(a)
designating an alternative benchmark rate (contractually or non-
...
(d)
amending the description of how the entity will assess hedge
effectiveness.
An entity also shall apply the requirement in paragraph 102P(c) if these three
conditions are met:
(a)
the entity makes a change required by interest rate benchmark reform
...
(c)
the chosen approach is economically equivalent to changing the basis
...
designation, an entity shall apply paragraphs 102V-102Z2 as applicable. An
102O
102P
102Q
102R
...
A1570
© IFRS Foundation
entity also shall apply paragraph 89 (for a fair value hedge) or paragraph 96
...
(a)
is denominated in the functional currency of the entity entering into
the transaction,
103Q
103R
103S
...
© IFRS Foundation
(b)
gives rise to an exposure that will have an effect on consolidated profit
or loss (ie is denominated in a currency other than the group's
presentation currency), and
(c)
would have qualified for hedge accounting had it not been
...
(b)
at the beginning of the reporting period in which an entity first applies
...
A1578
© IFRS Foundation
portion of the liability equal to the principal amount plus interest at LIBOR
...
example:
(a)
all of the cash flows of a financial instrument may be designated for
...
(a)
the forward contract is for the purchase of the same quantity of the
...
(c)
either the change in the discount or premium on the forward contract
...
© IFRS Foundation
A1583
the event or change in circumstances occurred, the entity discontinues hedge
...
(a)
As part of its risk management process the entity identifies a portfolio
...
(b)
The entity analyses the portfolio into repricing time periods based on
...
(c)
On the basis of this analysis, the entity decides the amount it wishes to
...
(d)
The entity designates the interest rate risk it is hedging. This risk could
...
(f)
Using the designations made in (c)-(e) above, the entity assesses at
...
designated.
(g)
Periodically, the entity measures the change in the fair value of the
...
(h)
The entity measures the change in fair value of the hedging
...
(i)
Any ineffectiveness3 will be recognised in profit or loss as the
...
© IFRS Foundation
A1585
amount of CU20 (a portion of the assets).4 The designation is expressed as an
...
example-must be:
(a)
items whose fair value changes in response to changes in the interest
rate being hedged; and
(b)
items that could have qualified for fair value hedge accounting if they
...
50 per cent of the liabilities5 with no demand feature.
...
(a)
which assets and liabilities are to be included in the portfolio hedge
and the basis to be used for removing them from the portfolio.
(b)
how the entity estimates repricing dates, including what interest rate
...
AG119
4
The Standard permits an entity to designate any amount of the available qualifying assets or
liabilities, ie in this example any amount of assets between CU0 and CU100.
5
...
(d)
how often the entity will test effectiveness and which of the two
methods in paragraph AG126 it will use.
(e)
the methodology used by the entity to determine the amount of assets
...
(f)
when the entity tests effectiveness using the method described
...
include written options or net written options, because the Standard6 does not
...
those repricing time periods because the Standard7 does not permit a hedging
...
the hedged interest rate have on those expected repricing dates shall be
AG120
AG121
6
...
© IFRS Foundation
A1587
included when determining the change in the fair value of the hedged item.
...
(a)
actual repricing dates being different from those expected, or expected
...
being different; and
(d)
other causes (eg when a few of the hedged items bear interest at a rate
...
(c)
when the repricing time periods used are narrower (eg 1-month as
...
(i)
calculates the percentage of the assets (or liabilities) in each
...
realised or rescheduled into other periods. Therefore, CU7 is derecognised
from the statement of financial position and recognised in profit or loss.
...
the first two time periods. When the first repricing time period expires,
AG127
AG128
AG129
AG130
...
A1590
© IFRS Foundation
CU110 of assets are derecognised because of expected and unexpected
...
related assets (or liabilities) being derecognised, the amount included in the
separate line item referred to in paragraph AG114(g) that relates to the
reduction shall be amortised in accordance with paragraph 92.
