...
# IAS 19 — Employee Benefits（雇员福利）⭐ 重点准则

## 📌 中文提炼

规范雇主对所有雇员福利的**确认、计量和披露**，涵盖四类福利。

### 四类雇员福利

| 类型 | 示例 | 会计处理 |
|------|------|----------|
| **短期雇员福利** | 工资、带薪年假、利润分享 | 在服务提供时确认为费用/负债（不折现） |
| **离职后福利** | 养老金、退休医疗 | 设定提存计划 / 设定受益计划，分别处理 |
| **其他长期福利** | 长期服务假、长期残疾福利 | 简化的设定受益计划会计 |
| **辞退福利** | 裁员补偿 | 早于解雇日和设定受益计划退休中较早者确认 |

### 设定提存计划（DC）vs 设定受益计划（DB）
| | 设定提存（DC） | 设定受益（DB） |
|------|---------------|---------------|
| **雇主义务** | 缴纳约定金额 | 承诺未来福利水平 |
| **风险承担** | 雇员承担投资/精算风险 | 雇主承担 |
| **会计处理** | 简单：计提当期缴款义务 | 复杂：预计单位贷记法（PUC） |

### 设定受益计划核心要点
- **预计单位贷记法（Projected Unit Credit）** 计量义务
- **精算假设**：折现率（高质量公司债收益率）、工资增长率、死亡率等
- **净设定受益负债/资产** = DBO - 计划资产公允价值 ± 资产上限影响
- 精算损益**全部计入 OCI**（不可循环至损益）
- 过去服务成本、结算利得/损失**计入当期损益**

### 关键判断
- 折现率选择对 DBO 金额高度敏感
- 资产上限（Asset Ceiling）：不能确认超过可退回/可减少未来缴款的盈余

> 养老金会计是财报中假设最密集的领域之一，需要精算师参与计算。
...
(issued February 2018), Amendments to References to the Conceptual Framework in IFRS Standards
(issued March 2018) and IFRS 18  Presentation and Disclosure in Financial Statements  (issued
April 2024).
IAS 19
...
> 💡 **中文注释：** DC vs DB 的核心判断——谁承担风险？DC 计划：雇主缴纳约定金额后无进一步义务，雇员承担投资风险和长寿风险；DB 计划：雇主承诺未来福利水平，无论计划资产盈亏都必须补足差额，雇主承担精算风险和投资风险。实务中许多计划具有混合特征——按经济实质归类，非法律形式。

CONTRIBUTION PLANS AND DEFINED BENEFIT PLANS 26
...
1–180 and Appendices A –B. All the paragraphs have equal authority but retain the
...
Standards and the Conceptual Framework for Financial Reporting. IAS 8 Basis of Preparation of
...
> 💡 **中文注释：** IAS 19 将雇员福利分为四类，其中设定受益计划（Defined Benefit Plan）的会计处理最为复杂——需运用精算假设（预计单位贷记法），涉及死亡率、折现率、工资增长率等多重假设。修订后的 IAS 19（2011 版）取消了"区间法（Corridor Approach）"——精算损益必须全部立即计入 OCI，不可递延或分摊。
...
dependants or beneficiaries and may be settled by payments (or the provision
...
A qualifying insurance policy is an insurance policy 1 issued by an insurer that
...
1 A qualifying insurance policy is not necessarily an insurance contract, as defined in IFRS 17
Insurance Contracts.
IAS 19
A1310 © IFRS Foundation
...
from the plan assets, together with realised and unrealised gains or losses
...
period, the entity shall recognise the undiscounted amount of short-term
...
of the benefits, an entity shall recognise that excess as an asset
...
are entitled to a cash payment for unused entitlement on leaving the entity) or
10
11
12
13
...
15
IAS 19
A1312 © IFRS Foundation

non-vesting (when employees are not entitled to a cash payment for unused
...
is recognised, even if the paid absences are non -vesting, although the
...
each, for eight employees). Therefore, the entity recognises a liability equal to twelve
days of sick pay.
...
absences for jury service or military service. An entity recognises no liability
...
entity recognises the cost of profit -sharing and bonus plans not as a
...
personnel. IFRS 18  Presentation and Disclosure in Financial Statements  requires
...
defined contribution plan in accordance with paragraph 34 shall recognise the
...
former employees of other entities. The definitions in this Standard require an
36
37
38
IAS 19
© IFRS Foundation A1317

entity to classify a group administration plan as a defined contribution plan or
a defined benefit plan in accordance with the terms of the plan (including any
constructive obligation that goes beyond the formal terms).
In determining when to recognise, and how to measure, a liability relating
...
recognise the net defined benefit cost so charged. If there is no such
agreement or policy, the net defined benefit cost shall be recognised in the
...
separate or individual financial statements, recognise a cost equal to their
...
period; future benefits earned during the current period will be paid out of
39
40
41
42
...
45
IAS 19
A1318 © IFRS Foundation

future contributions. Nevertheless, in most state plans the entity has no legal
...
> 💡 **中文注释：** DB 计划计量核心——预计单位贷记法（Projected Unit Credit Method）。将福利归属到服务期间，考虑未来工资增长（final salary plans）或固定福利（flat benefit plans）。折现率使用高质量公司债券的市场收益率，与福利的货币和期限匹配。注意：折现率每变动 1%，DBO 可能变动 10%-20%，这是 IAS 19 中最重要的单一假设。
...
the plan. Consequently, the expense recognised for a defined benefit plan is
...
constructive obligation because, at the end of each successive reporting
71
72
IAS 19
© IFRS Foundation A1325

period, the amount of future service that an employee will have to render
...
service.
3 A post-employment medical plan reimburses 40 per cent of an employ-
ee’s post-employment medical costs if the employee leaves after more
...
continued...
IAS 19
© IFRS Foundation A1327

...continued
Examples illustrating paragraph 73
4 A post-employment medical plan reimburses 10 per cent of an employ-
ee’s post-employment medical costs if the employee leaves after more
than ten and less than twenty years of service and 50 per cent of those
costs if the employee leaves after twenty or more years of service.
...
For employees expected to leave between ten and twenty years, the benefit  attrib-
uted to each of the first  ten years is 1 per cent of the present value of the expected
medical costs.
...
years of service, the entity is permitted to recognise such contributions
...
technological advances, changes in health care utilisation or delivery patterns
...
an entity recognises past service cost before any gain or loss on settlement.
...
recognise and measure any past service cost, or a gain or loss on settlement, in
...
determine the effect of the asset ceiling after the plan amendment,
96
97
98
99
...
101A
IAS 19
© IFRS Foundation A1333

curtailment or settlement and shall recognise any change in that effect in
accordance with paragraph 57(d).
Past service cost

> 💡 **中文注释：** 过去服务成本（Past Service Cost）是计划修订/缩减导致的 DBO 变动，**必须立即在当期损益确认**，不可递延或分摊。包括：引入新福利（正数）、削减福利（负数）、其他主体承担相关义务的结算（利得/损失）。注意：与旧版 IAS 19 不同——旧版允许在未来期间分期确认（已废除）。
...
from the return on plan assets that have been recognised in the
...
no past service cost because the entity recognised the estimated cost of
...
(a) recognise its right to reimbursement as a separate asset. The entity
...
benefit cost recognised in accordance with paragraph 120 may be
recognised net of amounts relating to changes in the carrying
...
An entity shall recognise the components of defined benefit cost, except to
...
paragraph 120.
Remeasurements of the net defined benefit liability (asset) recognised in
...
Components of defined benefit cost
Paragraph 120 requires an entity to recognise service cost and net interest on
...
(c) remeasurements of the net defined benefit liability (asset), showing
separately:
139
140
141
IAS 19
© IFRS Foundation A1341
...
required for post -employment benefits, this method does not recognise
...
An entity shall apply paragraphs 116–119 in recognising and measuring any
reimbursement right.
...
management personnel. IFRS 18 requires disclosure of employee benefits
expense.
...
Recognition
An entity shall recognise a liability and expense for termination benefits at
...
terminated.
When an entity recognises termination benefits, the entity may also have to
...
shall measure and recognise subsequent changes, in accordance with the
...
which the termination benefit is recognised, the entity shall apply
...
employment when the factory closes). Therefore the entity recognises a
...
when the plan of termination is announced and when the entity recognises
...
IFRS 18 requires disclosure of employee benefits expense.
...
Accounting Policies, Changes in Accounting Estimates and Errors,2 except that:
...
Accounting Estimates and Errors .3 Earlier application is permitted. If an entity
...
3 When it issued IFRS 18, the IASB changed the title of IAS 8.
IAS 19
A1350 © IFRS Foundation
...
the application of the amendment shall be recognised in retained earnings at
...
IFRS 18 issued in April 2024 amended paragraphs 25, 134, 158 and 171. An
entity shall apply those amendments when it applies IFRS 18.
177
178
179
180
IAS 19
© IFRS Foundation A1351
