...
# IAS 28 — Investments in Associates and Joint Ventures（联营和合营中的投资）


## 📌 中文提炼

规范**联营企业**和**合营企业**中投资的**权益法**会计处理。

### 适用范围
- **联营企业**（Associate）：投资者对其有**重大影响**（Significant Influence）——通常持股 20%-50%
- **合营企业**（Joint Venture）：按 IFRS 11 分类为合营企业的安排
...
- 重大交易往来
- 管理层人员交换
- 关键技术信息的提供（持股 <20% 也可能有重大影响）

### 权益法（Equity Method）
| 处理 | 说明 |
|------|------|
| **初始确认** | 按成本 |
| **后续调整** | + 享有被投资方利润份额 − 收到股利 |
| **其他 OCI 变动** | 按比例计入投资者的 OCI |
| **减值** | 整个投资作为一个资产按 IAS 36 减值测试 |
| **超额亏损** | 投资账面减至零后，仅在存在法定义务或推定义务时确认进一步损失 |

### 与投资者会计政策统一
被投资方采用不同会计政策时，应进行**调整**

### 例外
- 风险投资机构、共同基金等可选择按 IFRS 9 以公允价值计量
- 持有待售时按 IFRS 5 处理

> 与 IFRS 11（分类为合营经营 vs 合营企业）、IFRS 12（披露）、IFRS 3（分步合并中从联营到子公司）联动。
...
recognised in the investor’s other comprehensive income (see IFRS 18
...
with IFRS 9. The entity shall recognise in profit  or loss any
difference between:
...
entity shall account for all amounts previously recognised in other
...
or loss the gain or loss that had previously been recognised in other
...
assets taken into account in applying the equity method are those recognised
...
its associate or joint venture are recognised in the entity’s financial
...
realisable value of the assets to be sold or contributed, or of an impairment
...
realisable value of the assets to be purchased or of an impairment loss of those
assets, the investor shall recognise its share in those losses.
...
shall be accounted for in accordance with paragraph 28, except when the
25
26
27
28
...
contribution lacks commercial substance, as that term is described in IAS 16
Property, Plant and Equipment . If such a contribution lacks commercial
substance, the gain or loss is regarded as unrealised and is not recognised
unless paragraph 31 also applies. Such unrealised gains and losses shall be
...
an entity receives monetary or non-monetary assets, the entity recognises in
...
consolidated subsidiaries) and its associate or joint venture is recognised in
...
carrying amount of the investment. Amortisation of that goodwill is
not permitted.
...
recognising its share of further losses. The interest in an associate or a joint
...
associate or joint venture. For example, an item for which settlement is
33
34
35
36
...
neither planned nor likely to occur in the foreseeable future is, in substance,
...
for which adequate collateral exists, such as secured loans. Losses recognised
...
and a liability is recognised, only to the extent that the entity has incurred
...
the entity resumes recognising its share of those profits only after its share of
...
investment may be impaired. An impairment loss recognised in those
...
venture. Accordingly, any reversal of that impairment loss is recognised in
...
Errors .1 Earlier application is permitted. If an entity applies that amendment
...
recognise in the opening retained earnings (or other component of equity, as
...
IFRS 18 issued in April 2024 amended paragraph 10. An entity shall apply
...
Board. Mr Kabureck, Ms Lloyd and Mr Ochi dissented 2 from the issue of the amendments
...
Mary Tokar
Wei-Guo Zhang
2 Ms Patricia McConnell (former IASB member) intended to dissent from the issue of the
