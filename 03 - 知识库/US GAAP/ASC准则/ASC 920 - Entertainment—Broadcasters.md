---
tags: [us-gaap, asc-920]
standard: ASC 920
source: FASB ASC
source_url: https://asc.fasb.org/920/showallinonepage
...
**920-10-00-1** The following table identifies the changes made to this Subtopic.

| Paragraph | Action | Accounting Standards Update | Date |
| --- | --- | --- | --- |
| Barter | Superseded | Accounting Standards Update No. 2014-09 | 05/28/2014 |
| 920-10-05-2 | Amended | Accounting Standards Update No. 2014-09 | 05/28/2014 |
| 920-10-15-3 | Amended | Accounting Standards Update No. 2014-09 | 05/28/2014 |
...
**920-10-05-1** The Entertainment—Broadcasters Topic presents standards of financial accounting and reporting for broadcasters
.
**920-10-05-1** The Entertainment—Broadcasters Topic presents standards of financial accounting and reporting for broadcasters
**920-10-05-2** .
Overall
...
**920-10-15-1** . For guidance on matters related broadly to all financial instruments, (including the fair value option, accounting for registration payment arrangements, and broad financial instrument disclosure requirements), see Topic 825. See Section 825-10-15 for guidance on the scope of the Financial Instruments Topic.> Overall Guidance
The Subtopics within the Entertainment—Broadcasters Topic only provide incremental industry-specific guidance for the entities defined in this Scope Section, or as further defined in the Scope Sections of the individual Entertainment—Broadcasters Subtopics. Entities within the scope of this Topic also shall comply with the applicable standards not included in this Topic.
**920-10-15-1** The Subtopics within the Entertainment—Broadcasters Topic only provide incremental industry-specific guidance for the entities defined in this Scope Section, or as further defined in the Scope Sections of the individual Entertainment—Broadcasters Subtopics. Entities within the scope of this Topic also shall comply with the applicable standards not included in this Topic.
**920-10-15-2** > Entities
The guidance in the Entertainment—Broadcasters Topic applies to all entities that are considered broadcasters
1. Broadcasters that own the film (program material) shown on their cable, network, or local television outlets (for guidance see Topic 926).

**920-10-15-2** The guidance in the Entertainment—Broadcasters Topic applies to all entities that are considered broadcasters
1. Broadcasters that own the film (program material) shown on their cable, network, or local television outlets (for guidance see Topic 926).

**920-10-15-3** > Transactions
Network affiliation agreements
1. .

**920-10-15-3** Network affiliation agreements
1. .
